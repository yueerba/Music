package com.music.view.indicator;
...
//        final int defaultUnselectedColor = res.getColor(R.color.default_line_indicator_unselected_color);
        final int defaultSelectedColor = res.getColor(R.color.line_select);
        final int defaultUnselectedColor = res.getColor(R.color.line_background);
...
//        mPaintUnselected.setColor(R.color.line_background);
//        mPaintSelected.setColor(R.color.line_select);
